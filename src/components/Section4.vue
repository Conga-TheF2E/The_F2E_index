    ...
    <section class="Section4">
        ...
        <div class="titleBarPad">
            ...
            <div style="top: 50%; left: 50%; transform: translate(-50%, -50%)">
                <img src="../assets/img/Section4PadTitlebar2.svg" alt="" />
            </div>
            <div style="bottom: 0px; right: 0px">
                <img src="../assets/img/Section4PadTitlebar3.svg" alt="" />
            </div>
        </div>
        <div class="blockContainer">
            <div id="block1" class="block">
                <a
                    ...
                    @mouseover="enter1(), barEnter1()"
                    @mouseleave="leave1(), barLeave1()"
                ></a>
                <div class="outer"></div>
                <div class="hashtag">
            ...
            <div id="block2" class="block">
                <a
                    ...
                    target="_blank"
                    rel="noreferrer noopenner"
                    @mouseover="enter2(), barEnter2()"
                    @mouseleave="leave2(), barLeave2()"
                ></a>
                <div class="outer"></div>
                <div class="hashtag">
            ...
            <div id="block3" class="block">
                <a
                    ...
                    target="_blank"
                    rel="noreferrer noopenner"
                    @mouseover="enter3(), barEnter3()"
                    @mouseleave="leave3(), barLeave3()"
                ></a>
                <div class="outer">
                    <div class="hashtag" style="width: 174px">
                        <img src="../assets/img/hashtag_3.svg" alt="" />
                    </div>
                    <div class="outerContent" style="width: 266px; height: 35px; top: 135px">
                        <img src="../assets/img/Q3.svg" alt="" />
                    </div>
            ...
            <div class="blockPad">
                ...
                <a
                    ...
                    ><img
                        class="pointerPad"
                        src="../assets/img/Section4PointerRightPad.svg"
                        alt=""
                    />
                </a>
            ...
            <div class="blockPad">
                <a
                    ...
                    target="_blank"
                    rel="noreferrer noopenner"
                    ><img class="outerPad" src="../assets/img/Section4BlockPad3.svg" alt="" />
                </a>
                <img class="pointerPad" src="../assets/img/Section4PointerLeftPad.svg" alt="" />
                <p>
                    點擊查看<br />
